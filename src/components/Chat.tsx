                ...
                <div className="mb-6 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-amber-700">
                      <strong>Not Medical Advice:</strong> Healthic provides general wellness guidance only. Always consult a healthcare professional for medical concerns, diagnoses, or treatment decisions.
                    </p>
                  </div>
                </div>
